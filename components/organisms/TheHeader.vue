...
<template>
  <header class="sm:px-8 lg:px-16 w-full">
    <div class="max-w-screen-xl mx-auto px-8">
      <div class="relative max-w-2xl lg:max-w-5xl mx-auto flex justify-center flex-row items-center">
        <Transition>
        ...
        <div
          class="rounded-full px-3 shadow-lg shadow-zinc-800/5 ring-1 backdrop-filter backdrop-blur dark:bg-zinc-800/90 dark:ring-white/10">
