    ...
    <ul class="flex flex-col gap-4">
      <li v-for="experience in data" :key="experience._path">
        <NuxtLink :to="experience._path" class="relative group/item w-full flex flex-row items-center gap-4">
          <div
            class="absolute -inset-y-2 -inset-x-2 z-0 scale-95 bg-zinc-50 opacity-0 transition group-hover/item:scale-100 group-hover/item:opacity-100 dark:bg-zinc-800/50 rounded-md duration-200 ease-in"
          />
          <ExperienceImage
            small
