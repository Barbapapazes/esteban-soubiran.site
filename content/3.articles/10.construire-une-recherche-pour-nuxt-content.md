...
<!-- il faut ajouter des éléments à droite, comme UI (à faire dans une autre pr) -->
<!-- ça veut dire revoir un peu les maquettes mais c'est ok -->
...
Ainsi, dans cet article, nous allons voir comment construire une barre de recherche pour un site Nuxt Content. Plus précisément, nous allons ajouter une recherche au [template Alpine](https://github.com/nuxt-themes/alpine) !
